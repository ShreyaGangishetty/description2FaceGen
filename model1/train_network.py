...
def parse_arguments():
    ...
    parser.add_argument("--start_depth", action="store", type=int, default=4,
    ...
    parser.add_argument("--generator_file", action="store", type=str, default="training_runs/2/saved_models/GAN_GEN_3.pth",
                        help="pretrained Generator file (compatible with my code)")
    parser.add_argument("--discriminator_file", action="store", type=str, default="training_runs/2/saved_models/GAN_DIS_3.pth",
    ...
    for current_depth in range(start_depth, c_pro_gan.depth):
        ...
        for epoch in range(1, epochs[current_depth] + 1):
            ...
            for (i, batch) in enumerate(data, 1):
               ...
               #embeddings = th.from_numpy(encoder(captions))
                # embeddings = th.from_numpy(captions).to(device)
